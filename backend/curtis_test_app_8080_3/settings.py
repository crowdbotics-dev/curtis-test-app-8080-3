"""
Django settings for curtis_test_app_8080_3 project.
...
ROOT_URLCONF = 'curtis_test_app_8080_3.urls'
...
WSGI_APPLICATION = 'curtis_test_app_8080_3.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "curtis test app 8080 Support <support@curtis-test-app-8080-3.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "curtis_test_app_8080_3 API",
    "DESCRIPTION": "API documentation for curtis_test_app_8080_3 App",
    "VERSION": "v1",
}
